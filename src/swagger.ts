...
// SWAGGER BASE CONFIG
// ===========================================================
// OpenAPI base definition and reusable schemas.
// Route-level @swagger JSDoc can live in module *.routes.ts files.
// ===========================================================
        ...
        RegisterBody: {
          ...
          properties: {
            ...
            role: {
              ...
              example: "BUSINESS",
              description:
                "Optional account type. ADMIN cannot be created from signup.",
            },
            cardId: {
              type: "string",
              example: "CARD_AB3K2L",
              description: "Optional: activate a card at registration",
            },
          },
        },
        LoginBody: {
        ...
        CreateCardBody: {
          ...
          properties: {
            count: {
              type: "integer",
              example: 5,
              description: "Number of cards to generate (max 100)",
            },
          },
        },
        ErrorResponse: {
